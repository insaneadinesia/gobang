...
type RestClient interface {
	...
	Post(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error)
	Put(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error)
	Patch(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error)
	Delete(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error)
}
...
func (c *client) Post(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error) {
	body, statusCode, err = c.call(ctx, http.MethodPost, path, headers, requestBody)
	return
}

func (c *client) Put(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error) {
	body, statusCode, err = c.call(ctx, http.MethodPut, path, headers, requestBody)
	return
}

func (c *client) Patch(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error) {
	body, statusCode, err = c.call(ctx, http.MethodPatch, path, headers, requestBody)
	return
}

func (c *client) Delete(ctx context.Context, path string, headers http.Header, requestBody []byte) (body []byte, statusCode int, err error) {
	body, statusCode, err = c.call(ctx, http.MethodDelete, path, headers, requestBody)
	return
}
